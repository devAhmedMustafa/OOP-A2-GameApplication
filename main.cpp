...
#include "Inverse Tic-Tac-Toe/ITTT_Gameplay.h"

using namespace std;

vector<string> games_names = {"Pyramic Tic-Tac-Toe", "Four in row", "5x5 Tic-Tac-Toe", "Numerical Tic-Tac-Toe", "Inverse Tic-Tac-Toe", "Ultimate Tic-Tac-Toe", "SUS Tic-Tac-Toe", "Word Tic-Tac-Toe"};
...
vector games = { pttt_ui, c4_ui, fxf_ui, nttt_ui, ittt_ui, uttt_ui, sus_ui, wttt_ui };
